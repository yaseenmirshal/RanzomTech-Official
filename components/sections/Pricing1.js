                                ...
                                <div className="pricinge-head d-flex align-items-center ps-xxl-10 ps-xl-7 ps-lg-5 ps-5">
                                    <div className="box">
                                       ...
                                       Static Website 
                                        ...
                                        <p className="pra-clr">
                                        Best for small businesses - Perfect for landing pages, local businesses, and personal brands.
                                        </p>
                                    </div>
                                </div>
                                <div className="pricing-list-right d-lg-flex d-grid align-items-center justify-content-between gap-lg-4 gap-7 w-100 ps-xxl-20 ps-lg-10 ps-5 pe-xxl-10 pe-8 pb-lg-0 pb-6">
                                    <ul className="pricing-list d-grid gap-xxl-2 gap-1">
                                        ...
                                        <li className="d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2">
                                            ...
                                            <span className="pra-clr">
                                                  Basic SEO + Fast Performance Setup
                                            </span>
                                        </li>
                                        <li className="d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2">
                                            <svg width={16} height={17} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="mpricing-item other-pricing-item d-flex align-items-center">
                                <div className="pricinge-head d-flex align-items-center ps-xxl-10 ps-xl-7 ps-lg-5 ps-5">
                                    <div className="box">
                                        ...
                                        <p className="pra-clr">
                                        Best for businesses that want to start selling fast with easy product management.
                                        </p>
                                    </div>
                                </div>
                                <div className="pricing-list-right d-lg-flex d-grid align-items-center justify-content-between gap-lg-4 gap-7 w-100 ps-xxl-20 ps-lg-10 ps-5 pe-xxl-10 pe-8 pb-lg-0 pb-6">
                                    <ul className="pricing-list d-grid gap-xxl-2 gap-1">
                                        ...
                                        <li className="d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2">
                                            ...
                                            <span className="pra-clr">
                                            Up to 50 Products Upload + Collections
                                            </span>
                                        </li>
                                        <li className="d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2">
                                            <svg width={16} height={17} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <span className="pra-clr">
                                            Payment Setup + Shipping Settings
                                            </span>
                                        </li>
                                        <li className="d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2">
                                            <svg width={16} height={17} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <span className="pra-clr">
                                            SEO + Store Optimization + 30 Days Support
                                            </span>
                                        </li>
                                    </ul>
                                    <div className="price-choose d-flex align-items-center gap-xxl-15 gap-xl-10 gap-lg-7 gap-md-6 gap-sm-4 gap-3">
                            ...
                            <div className="mpricing-item other-pricing-item d-flex align-items-center">
                                <div className="pricinge-head d-flex align-items-center ps-xxl-10 ps-xl-7 ps-lg-5 ps-5">
                                    <div className="box">
                                        ...
                                        <p className="pra-clr">
                                        Ideal for businesses ready to invest in scalable marketing that generates consistent leads and measurable results.
                                        </p>
                                    </div>
                                </div>
                                <div className="pricing-list-right d-lg-flex d-grid align-items-center justify-content-between gap-lg-4 gap-7 w-100 ps-xxl-20 ps-lg-10 ps-5 pe-xxl-10 pe-8 pb-lg-0 pb-6">
                                    <ul className="pricing-list d-grid gap-xxl-2 gap-1">
                                        ...
                                        <li className="d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2">
                                            ...
                                            <span className="pra-clr">
                                            3 High-Converting Ad Creatives / week
                                            </span>
                                        </li>
                                        <li className="d-flex align-items-center gap-xxl-5 gap-xl-4 gap-lg-3 gap-2">
                                            <svg width={16} height={17} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <span className="pra-clr">
                                            Weekly Reporting + Growth Optimization
                                            </span>
                                        </li>
                                    </ul>
                                    <div className="price-choose d-flex align-items-center gap-xxl-15 gap-xl-10 gap-lg-7 gap-md-6 gap-sm-4 gap-3">
